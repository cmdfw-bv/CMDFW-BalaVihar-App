...
|---|---|---|---|---|---|
| [children-attendance-view](children-attendance-view.md) | POC-core | Parent | Parent | own-children (ADR-0018) | Built ✓ — client-only, no migration needed ([plan](children-attendance-view.plan.md)) |
