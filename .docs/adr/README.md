...
| [ADR-0030](0030-class-updates-system-owned.md) | `class_updates` is a System-owned schema addition, not Coordinator-owned or gated on Teacher's unrefined "post class update" item | Closed | 2026-07-24 |
| [ADR-0031](0031-class-meeting-calendar.md) | Explicit `class_meetings` calendar (System-owned, `sessions.meeting_weekday` + CSV-import-driven skip weeks) is the source of truth for expected meeting dates | Closed | 2026-07-24 |
