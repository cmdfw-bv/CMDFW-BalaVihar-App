...
| [ADR-0034](0034-class-updates-system-owned.md) | `class_updates` is a System-owned schema addition, not Coordinator-owned or gated on Teacher's unrefined "post class update" item (renumbered from 0030; shape superseded by ADR-0036) | Closed | 2026-07-24 |
| [ADR-0035](0035-class-meeting-calendar.md) | Explicit `class_meetings` calendar (System-owned, driven by ADR-0031's `sessions.day_of_week` + CSV-import skip weeks) is the source of truth for expected meeting dates (renumbered from 0031; amended by ADR-0036) | Closed | 2026-07-24 |
...
| ADR-0037 | *Reserved* — enrollment withdrawal revokes participation, not history. Allocated to issue #58 (`architect/issue-58-withdrawal-conversational-access`) under the allocate-at-reconciliation rule; the record lands when that PR merges. Not a numbering gap. | Reserved | — |
| [ADR-0038](0038-class-meetings-generated-by-trigger.md) | The class-meeting calendar is generated by a database trigger on `classes` insert, not by a call at session-creation time — supersedes ADR-0035's generation-mechanism clause | Closed | 2026-08-16 |
