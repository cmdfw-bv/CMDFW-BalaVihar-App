...
insert into sessions (id, center_id, name, start_date, end_date, meeting_weekday)
  values ('a3111111-0000-0000-0000-000000000001', 'c9999999-0000-0000-0000-000000000001', 'Audit-Session', '2026-01-01', '2026-06-01', 0);
...
select tests.clear_authentication();
insert into sessions (id, center_id, name, start_date, end_date, meeting_weekday)
  values ('a3111111-0000-0000-0000-000000000099', 'c9999999-0000-0000-0000-000000000001', 'Audit-Session-Unrelated', '2026-01-01', '2026-06-01', 0);
insert into classes (id, session_id, name, grade_band)
