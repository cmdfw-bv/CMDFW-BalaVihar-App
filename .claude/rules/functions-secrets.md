...
- **Three jobs only** at POC: `push-send` (web-push), `email-send` (AWS SES), `csv-import` (enrollment, service role). Don't add functions that duplicate what the client can do directly against RLS-protected Supabase.
